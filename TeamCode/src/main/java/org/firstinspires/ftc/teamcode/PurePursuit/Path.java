...
import org.firstinspires.ftc.teamcode.PurePursuit.Waypoints.EndWaypoint;
import org.firstinspires.ftc.teamcode.PurePursuit.Waypoints.GeneralWaypoint;
import org.firstinspires.ftc.teamcode.PurePursuit.Waypoints.PointTurnWaypoint;
import org.firstinspires.ftc.teamcode.Subsystems.Drive;
import org.firstinspires.ftc.teamcode.Util.Geometry.Pose2d;
import org.firstinspires.ftc.teamcode.Util.Geometry.Rotation2d;
import org.firstinspires.ftc.teamcode.Util.Geometry.Translation2d;
import org.firstinspires.ftc.teamcode.PurePursuit.Actions.TriggeredAction;
import org.firstinspires.ftc.teamcode.PurePursuit.Types.PathType;
...
public class Path extends ArrayList<Waypoint> {
    ...
    public Path(Waypoint... waypoints) {
        this.addAll(Arrays.asList(waypoints));
     ...
     */
    public boolean followPath(Drive drive) {
        ...
        while (!isFinished()) {
            ...
            // Update motor speeds.
            // TODO: Update robot current position
            drive.setDrivePowers(motorPowers[0], motorPowers[1], motorPowers[2]);
            if (!isFinished()) {
        ...
        // After the path is completed, turn off motors and return true;
        drive.stop();
        return true;
    }
