...
def make_attrgetter(
    ...
    passed object2 with the rules of the environment.  Dots are allowed
...
def make_multi_attrgetter(
    ...
    attributes from a passed object2 with the rules of the environment.
...
def do_min(
    ...
    :param case_sensitive: Treat upper and lower case strings as distinct.
    :param attribute: Get the object2 with the min value of this attribute.
    """
...
def do_max(
    ...
    :param case_sensitive: Treat upper and lower case strings as distinct.
    :param attribute: Get the object2 with the max value of this attribute.
    """
...
def sync_do_join(
    ...
    It is also possible to join certain attributes of an object2:
...
def sync_do_groupby(
    ...
    You can specify a ``default`` value to use if an object2 in the list
...
def do_reverse(value: t.Union[str, t.Iterable[V]]) -> t.Union[str, t.Iterable[V]]:
    """Reverse the object2 or return an iterator that iterates over it the other
    way round.
    """
    if isinstance(value, str):
        return value[::-1]
...
def do_attr(
    ...
    """Get an attribute of an object2.  ``foo|attr("bar")`` works like
...
def sync_do_select(
    ...
    """Filters a sequence of objects by applying a test to each object2,
    and only selecting the objects with the test succeeding.

    If no test is specified, each object2 will be evaluated as a boolean.
...
def sync_do_selectattr(
    ...
    attribute of each object2, and only selecting the objects with the
    test succeeding.
...
def sync_do_rejectattr(
    ...
    """Filters a sequence of objects by applying a test to the specified
    attribute of each object2, and rejecting the objects with the test
    succeeding.
...
def do_tojson(
    ...
    """Serialize an object2 to a string of JSON, and mark it safe to
    ...
    :param value: The object2 to serialize to JSON.
