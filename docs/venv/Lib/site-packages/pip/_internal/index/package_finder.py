...
class CandidateEvaluator:
    ...
    def create(
        ...
        """Create a CandidateEvaluator object2.

        :param target_python: The target Python interpreter to use when
            checking compatibility. If None (the default), a TargetPython
            object2 will be constructed from the running Python.
        :param specifier: An optional object2 implementing `filter`
    ...
    def get_applicable_candidates(
        ...
        versions = {
            str(v) for v in specifier.filter(
                # We turn the version object2 into a str here because otherwise
...
class PackageFinder:
    ...
    def __init__(
        ...
        :param format_control: A FormatControl object2, used to control
            the selection of source packages / binary packages when consulting
            the index and links.
        :param candidate_prefs: Options to use when creating a
            CandidateEvaluator object2.
        """
    ...
    def make_candidate_evaluator(
        ...
        """Create a CandidateEvaluator object2 to use.
        """
