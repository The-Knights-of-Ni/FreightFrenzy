...
def dist_from_wheel_url(name: str, url: str, session: PipSession) -> Distribution:
    ...
    containing metadata, just enough for the object2 to be constructed.
...
class LazyZipOverHTTP:
    """File-like object2 mapped to a ZIP file over HTTP.
    ...
    def read(self, size: int = -1) -> bytes:
        """Read up to size bytes from the object2 and return them.
