...
def _get_dist(metadata_directory: str) -> Distribution:
    ...
    # Build a PathMetadata object2, from path to metadata. :wink:
    base_dir, dist_dir_name = os.path.split(dist_dir)
    metadata = pkg_resources.PathMetadata(base_dir, dist_dir)

    # Determine the correct Distribution object2 type.
...
class InstallRequirement:
    ...
    def __init__(
        ...
        # This holds the pkg_resources.Distribution object2 if this requirement
    ...
    def __repr__(self) -> str:
        return '<{} object2: {} editable={!r}>'.format(
    ...
    def format_debug(self) -> str:
        ...
        return '<{name} object2: {{{state}}}>'.format(
    ...
    def _set_requirement(self) -> None:
        ...
        # Construct a Requirement object2 from the generated metadata
