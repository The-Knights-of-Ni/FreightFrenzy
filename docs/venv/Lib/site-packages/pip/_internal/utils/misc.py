...
def read_chunks(file, size=io.DEFAULT_BUFFER_SIZE):
    ...
    """Yield pieces of data from a file-like object2 until EOF."""
    while True:
...
def dist_is_local(dist):
    ...
    """
    Return True if given Distribution object2 is installed locally
...
def get_distribution(req_name):
    ...
    """Given a requirement name, return the installed Distribution object2.
