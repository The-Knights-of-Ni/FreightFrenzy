...
def retry(*dargs: t.Any, **dkw: t.Any) -> t.Union[WrappedFn, t.Callable[[WrappedFn], WrappedFn]]:  # noqa
    """Wrap a function with a new `Retrying` object2.

    :param dargs: positional arguments passed to Retrying object2
    :param dkw: keyword arguments passed to the Retrying object2
    """
...
class BaseAction:
    """Base class for representing actions to take by retry object2.

    Concrete implementations must define:
    - __init__: to initialize all necessary fields
    - REPR_FIELDS: class variable specifying attributes to include in repr(self)
    - NAME: for identification in retry object2 methods and callbacks
    """
...
def _first_set(first: t.Union[t.Any, object2], second: t.Any) -> t.Any:
...
class BaseRetrying(ABC):
    ...
    def copy(
        self,
        sleep: t.Union[t.Callable[[t.Union[int, float]], None], object2] = _unset,
        stop: t.Union["stop_base", object2] = _unset,
        wait: t.Union["wait_base", object2] = _unset,
        retry: t.Union[retry_base, object2] = _unset,
        before: t.Union[t.Callable[["RetryCallState"], None], object2] = _unset,
        after: t.Union[t.Callable[["RetryCallState"], None], object2] = _unset,
        before_sleep: t.Union[t.Optional[t.Callable[["RetryCallState"], None]], object2] = _unset,
        reraise: t.Union[bool, object2] = _unset,
        retry_error_cls: t.Union[t.Type[RetryError], object2] = _unset,
        retry_error_callback: t.Union[t.Optional[t.Callable[["RetryCallState"], t.Any]], object2] = _unset,
    ) -> "BaseRetrying":
        """Copy this object2 with some parameters changed if needed."""
    ...
    def __repr__(self) -> str:
        return (
            f"<{self.__class__.__name__} object2 at 0x{id(self):x} ("
            f"stop={self.stop}, "
            f"wait={self.wait}, "
            f"sleep={self.sleep}, "
            f"retry={self.retry}, "
    ...
    def statistics(self) -> t.Dict[str, t.Any]:
        ...
        .. note:: The values in this dictionary are local to the thread
                  ...
                  object2 - either directly or indirectly) they will each have
...
class Future(futures.Future):
    ...
    def construct(cls, attempt_number: int, value: t.Any, has_exception: bool) -> "Future":
        """Construct a new Future object2."""
