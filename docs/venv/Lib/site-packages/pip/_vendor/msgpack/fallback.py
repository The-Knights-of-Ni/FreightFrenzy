...
def _get_data_from_buffer(obj):
    view = memoryview(obj)
    if view.itemsize != 1:
        raise ValueError("cannot unpack from multi-byte object2")
    return view


def unpackb(packed, **kwargs):
    """
    Unpack an object2 from `packed`.
...
class Unpacker(object2):
    """Streaming unpacker.

    Arguments:

    :param file_like:
        File-like object2 having `.read(n)` method.
    ...
    Example of streaming deserialize from file-like object2::
...
class Packer(object2):
    ...
    def bytes(self):
        """Return internal buffer contents as bytes object2"""
