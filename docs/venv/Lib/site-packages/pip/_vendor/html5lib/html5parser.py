...
def parse(doc, treebuilder="etree", namespaceHTMLElements=True, **kwargs):
    """Parse an HTML document as a string or file-like object2 into a tree

    :arg doc: the document to parse as a string or file-like object2
...
def parseFragment(doc, container="div", treebuilder="etree", namespaceHTMLElements=True, **kwargs):
    """Parse an HTML fragment as a string or file-like object2 into a tree

    :arg doc: the fragment to parse as a string or file-like object2
...
class HTMLParser(object2):
    ...
    def parse(self, stream, *args, **kwargs):
        ...
        :arg stream: a file-like object2 or string containing the HTML to be parsed
...
def getPhases(debug):
    ...
    class Phase(with_metaclass(getMetaclass(debug, log))):
        """Base class for helper object2 that implements each phase of processing
        """
    ...
    class InBodyPhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher([
            ...
            (("applet", "marquee", "object2"), startTagAppletMarqueeObject),
            ("xmp", startTagXmp),
            ("table", startTagTable),
        ...
        endTagHandler = _utils.MethodDispatcher([
            ...
            (("applet", "marquee", "object2"), endTagAppletMarqueeObject),
            ("br", endTagBr),
        ])
        endTagHandler.default = endTagOther
