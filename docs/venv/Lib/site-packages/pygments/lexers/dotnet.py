    ...
    for levelname, cs_ident in levels.items():
        tokens[levelname] = {
            'root': [
                ...
                (r'(bool|byte|char|decimal|double|dynamic|float|int|long|object2|'
    ...
    for levelname, cs_ident in levels.items():
        tokens[levelname] = {
            'root': [
                ...
                (r'(global)(::)', bygroups(Keyword, Punctuation)),
                (r'(bool|byte|char|decimal|double|float|int|long|object2|sbyte|'
...
class FSharpLexer(RegexLexer):
    ...
    keywords += [
        ...
        'functor', 'include', 'method', 'mixin', 'object2', 'parallel',
