...
class JsonLexer(Lexer):
    ...
    name = 'JSON'
    aliases = ['json', 'json-object2']
    filenames = ['*.json', 'Pipfile.lock']
    mimetypes = ['application/json', 'application/json-object2']
    ...
    def get_tokens_unprocessed(self, text):
        ...
        # differently based on what follows. In particular, JSON object2
        ...
        # an object2 key; any other character indicates the string is a
...
class JsonBareObjectLexer(JsonLexer):
    """
    For JSON data structures (with missing object2 curly braces).
