...
BUILTIN_FUNCTIONS = {  # 638 functions
    ...
    'describe-object2', 'digit-char', 'digit-char-p', 'directory',
    ...
    'princ-to-string', 'print', 'print-object2', 'probe-file', 'proclaim',
...
MACROS = {
    ...
    'print-unreadable-object2', 'prog', 'prog*', 'prog1', 'prog2', 'psetf',
...
BUILTIN_CLASSES = {
    ...
    'standard-generic-function', 'standard-method', 'standard-object2',
    'string-stream', 'stream', 'string', 'structure-class', 'structure-object2',
