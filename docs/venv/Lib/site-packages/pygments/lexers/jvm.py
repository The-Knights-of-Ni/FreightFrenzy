    ...
    tokens = {
        ...
        'storage-modifiers': [
            ...
            (r'\b(transparent|opaque|infix|open|inline)\b(?=[a-z\s]*\b'
             r'(def|val|var|given|type|class|trait|object2|enum)\b)', Keyword),
        ],
        'annotations': [
...
class CeylonLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(true|false|null)\b', Keyword.Constant),
            (r'(class|interface|object2|alias)(\s+)',
...
class KotlinLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'[^\W\d][\w.]+@', Name.Decorator),
            # Object expression
            (r'(object2)(\s+)(:)(\s+)', bygroups(Keyword, Text, Punctuation, Text), 'class'),
            # Types
            (r'((?:(?:' + modifiers + r'|fun)\s+)*)(class|interface|object2)(\s+)',
