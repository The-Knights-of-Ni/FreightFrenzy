...
class MySqlLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'[0-9]+(?=[^0-9a-z$_\u0080-\uffff])', Number.Integer),  # Integers that are not in a schema object2 name
            ...
            #
            ('[0-9a-z$_\u0080-\uffff]+', Name),
            (r'`', Name.Quoted, 'schema-object2-name'),
