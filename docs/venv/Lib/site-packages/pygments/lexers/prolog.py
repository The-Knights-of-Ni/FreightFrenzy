...
class LogtalkLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            # Entity
            (r'(abolish|c(reate|urrent))_(object2|protocol|category)(?=[(])', Keyword),
            (r'(object2|protocol|category)_property(?=[(])', Keyword),
            # Entity relations
            (r'co(mplements_object|nforms_to_protocol)(?=[(])', Keyword),
            (r'extends_(object2|protocol|category)(?=[(])', Keyword),
        ...
        'directive': [
            ...
            # Entity directives
            (r'(category|object2|protocol)(?=[(])', Keyword, 'entityrelations'),
            (r'(end_(category|object2|protocol))(?=[.])', Keyword, 'root'),
