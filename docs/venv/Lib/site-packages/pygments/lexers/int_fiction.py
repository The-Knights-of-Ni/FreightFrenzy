...
class Inform6Lexer(RegexLexer):
    ...
    tokens = {
        ...
        'directive': [
            ...
            (r'(?i)class\b', Keyword,
             ('object2-body', 'duplicates', 'class-name')),
            ...
            (r'(?i)(nearby|object2)\b', Keyword,
             ('object2-body', '_object-head')),
            ...
            (_name, Name.Class, ('object2-body', '_object-head'))
        ],
        # [, Replace, Stub
        'routine-name?': [
            include('_whitespace'),
        ...
        'miscellaneous-keyword?': [
            ...
            (r'(bold|fixed|from|near|off|on|reverse|roman|to|underline)\b',
             Keyword, '#pop'),
            (r'(a|A|an|address|char|name|number|object2|property|string|the|'
...
class Tads3Lexer(RegexLexer):
    ...
    tokens = {
        ...
        'main/root': [
            include('main/basic'),
            default(('#pop', 'object2-body/no-braces', 'classes', 'class'))
        ],
        'object2-body/no-braces': [
            (r';', Punctuation, '#pop'),
            (r'\{', Punctuation, ('#pop', 'object2-body')),
            include('object2-body')
        ],
        'object2-body': [
            (r';', Punctuation),
            (r'\{', Punctuation, '#push'),
            ...
            (r'(%s)(%s*)(:)' % (_name, _ws),
             bygroups(Name.Variable, using(this, state='whitespace'),
                      Punctuation),
             ('object2-body/no-braces', 'classes', 'class')),
            include('whitespace'),
            (r'->|%s' % _operator, Punctuation, 'main'),
            default('main/object2-body')
        ],
        'main/object2-body': [
            include('main/basic'),
            (r'(%s)(%s*)(=?)' % (_name, _ws),
        ...
        'block?/root': [
            ...
            (r'(?=[\[\'"<(:])', Text,  # It might be a VerbRule macro.
             ('#pop', 'object2-body/no-braces', 'grammar', 'grammar-rules')),
            # It might be a macro like DefineAction.
            default(('#pop', 'object2-body/no-braces'))
        ],
        'block?': [
            (r'\{', Punctuation, ('#pop', 'block')),
            include('whitespace'),
        ...
        'main/basic': [
            ...
            (r'(modify)(%s+)(grammar\b)' % _ws,
             bygroups(Keyword.Reserved, using(this, state='whitespace'),
                      Keyword.Reserved),
             ('#pop', 'object2-body/no-braces', ':', 'grammar')),
            (r'(new)(%s+(?=(?:function|method)\b))' % _ws,
             bygroups(Keyword.Reserved, using(this, state='whitespace'))),
            (r'(object2)(%s+)(template\b)' % _ws,
             bygroups(Keyword.Reserved, using(this, state='whitespace'),
            ...
            (r'class\b', Keyword.Reserved,
             ('#pop', 'object2-body/no-braces', 'class')),
            ...
            (r'object2\b', Keyword.Reserved, ('#pop', 'object2-body/no-braces')),
        ...
        'class': [
            (r'\*|\.{3}', Punctuation, '#pop'),
            (r'object2\b', Keyword.Reserved, '#pop'),
