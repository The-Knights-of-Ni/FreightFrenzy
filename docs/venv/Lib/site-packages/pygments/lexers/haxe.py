...
class HaxeLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        # bracket can be block or object2
        'bracket': [
            include('spaces'),
        ...
        'bracket-check': [
            include('spaces'),
            (r':', Punctuation, ('#pop', 'object2-sep', 'expr')),  # is object2
        ...
        # object2 in key-value pairs
        'object2': [
            include('spaces'),
            (r'\}', Punctuation, '#pop'),
            default(('#pop', 'object2-sep', 'expr', 'colon', 'ident-or-string'))
        ],
        ...
        # after a key-value pair in object2
        'object2-sep': [
            include('spaces'),
            (r'\}', Punctuation, '#pop'),
            (r',', Punctuation, ('#pop', 'object2')),
        ],
