...
class LSLLexer(RegexLexer):
    ...
    lsl_events = r'\b(?:state_(?:entry|exit)|touch(?:_(?:start|end))?|(?:land_)?collision(?:_(?:start|end))?|timer|listen|(?:no_)?sensor|control|(?:not_)?at_(?:rot_)?target|money|email|run_time_permissions|changed|attach|dataserver|moving_(?:start|end)|link_message|(?:on|object2)_rez|remote_data|http_re(?:sponse|quest)|path_update|transaction_result)\b'
...
class AppleScriptLexer(RegexLexer):
    ...
    StudioProperties = ('accepts arrow key', 'action method', 'active',
                        ...
                        'associated object2', 'auto completes', 'auto display',
