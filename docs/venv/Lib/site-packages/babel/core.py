...
class Locale(object2):
    ...
    A `Locale` object2 can also be instantiated from a raw locale string:
    ...
    def __init__(self, language, territory=None, script=None, variant=None):
        """Initialize the locale object2 from the given identifier components.
    ...
    def parse(cls, identifier, sep='_', resolve_likely_subtags=True):
        ...
        object2, that object2 is returned:
