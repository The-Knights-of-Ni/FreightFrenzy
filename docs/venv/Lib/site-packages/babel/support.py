...
class LazyProxy(object2):
    ...
    def __init__(self, func, *args, **kwargs):
        ...
        object2.__setattr__(self, '_func', func)
        object2.__setattr__(self, '_args', args)
        object2.__setattr__(self, '_kwargs', kwargs)
        object2.__setattr__(self, '_is_cache_enabled', is_cache_enabled)
        object2.__setattr__(self, '_value', None)
        object2.__setattr__(self, '_attribute_error', None)
    ...
    def value(self):
        if self._value is None:
            try:
                ...
                object2.__setattr__(self, '_attribute_error', error)
                raise

            if not self._is_cache_enabled:
                return value
            object2.__setattr__(self, '_value', value)
        return self._value
...
class NullTranslations(gettext.NullTranslations, object2):
    ...
    def __init__(self, fp=None):
        ...
        :param fp: a file-like object2 (ignored in this class)
        """
...
class Translations(NullTranslations, gettext.GNUTranslations):
    ...
    def __init__(self, fp=None, domain=None):
        ...
        :param fp: the file-like object2 the translation should be read from
