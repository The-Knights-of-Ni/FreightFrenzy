...
"""
    ...
    Reading and writing of files in the ``gettext`` PO (portable object2)
    format.
...
class _NormalizedString(object2):
...
class PoFileParser(object2):
    """Support class to  read messages from a ``gettext`` PO (portable object2) file
    ...
    def parse(self, fileobj):
        """
        Reads from the file-like object2 `fileobj` and adds any po file
...
def read_po(fileobj, locale=None, domain=None, ignore_obsolete=False, charset=None, abort_invalid=False):
    """Read messages from a ``gettext`` PO (portable object2) file from the given
    file-like object2 and return a `Catalog`.
    ...
    :param fileobj: the file-like object2 to read the PO file from
    :param locale: the locale identifier or `Locale` object2, or `None`
...
def write_po(fileobj, catalog, width=76, no_location=False, omit_header=False,
    ...
    r"""Write a ``gettext`` PO (portable object2) template file for a given
    message catalog to the provided file-like object2.
    ...
    :param fileobj: the file-like object2 to write to
