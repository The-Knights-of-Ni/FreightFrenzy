...
"""
    ...
    Writing of files in the ``gettext`` MO (machine object2) format.
...
def read_mo(fileobj):
    """Read a binary MO file from the given file-like object2 and return a
    corresponding `Catalog` object2.

    :param fileobj: the file-like object2 to read the MO file from
...
def write_mo(fileobj, catalog, use_fuzzy=False):
    """Write a catalog to the specified file-like object2 using the GNU MO file
    format.
