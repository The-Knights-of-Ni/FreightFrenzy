...
def extract(method, fileobj, keywords=DEFAULT_KEYWORDS, comment_tags=(),
    ...
    """Extract messages from the given file-like object2 using the specified
    extraction method.
    ...
    :param fileobj: the file-like object2 the messages should be extracted from
    :param keywords: a dictionary mapping keywords (i.e. names of functions
                     that should be recognized as translation functions) to
                     tuples that specify which of their arguments contain
                     localizable strings
...
def extract_python(fileobj, keywords, comment_tags, options):
    ...
    :param fileobj: the seekable, file-like object2 the messages should be
                    extracted from
