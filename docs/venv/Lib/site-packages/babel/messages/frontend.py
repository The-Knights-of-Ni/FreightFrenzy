...
class Command(_Command):
    ...
    #: Log object2. To allow replacement in the script command line runner.
    log = distutils_log
...
def check_message_extractors(dist, name, value):
    ...
    :param dist: the distutils/setuptools ``Distribution`` object2
...
class CommandLineInterface(object2):
...
def parse_mapping(fileobj, filename=None):
    """Parse an extraction method mapping from a file-like object2.
    ...
    :param fileobj: a readable file-like object2 containing the configuration
                    text to parse
