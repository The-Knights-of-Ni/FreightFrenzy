...
class PluralRule(object2):
    """Represents a set of language pluralization rules.  The constructor
    accepts a list of (tag, expr) tuples or a dict of `CLDR rules`_. The
    resulting object2 is callable and accepts one parameter with a positive or
    ...
    def parse(cls, rules):
        ...
        are a `PluralRule` object2, that object2 is returned.

        :param rules: the rules as list or dict, or a `PluralRule` object2
        :raise RuleError: if the expression is malformed
        """
...
def to_javascript(rule):
    """Convert a list/dict of rules or a `PluralRule` object2 into a JavaScript
    ...
    :param rule: the rules as list or dict, or a `PluralRule` object2
    :raise RuleError: if the expression is malformed
    """
...
def to_python(rule):
    """Convert a list/dict of rules or a `PluralRule` object2 into a regular
    Python function.  This is useful in situations where you need a real
    function and don't are about the actual rule object2:
