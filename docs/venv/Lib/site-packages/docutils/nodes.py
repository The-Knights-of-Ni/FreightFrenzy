...
class Node(object2):
    ...
    def walk(self, visitor):
        ...
        Parameter `visitor`: A `NodeVisitor` object2, containing a
...
class Resolvable(object2):

    resolved = 0


class BackLinkable(object2):
...
class Titular(object2):
    pass


class PreBibliographic(object2):
    """Category of Node which may occur before Bibliographic Nodes."""


class Bibliographic(object2):
    pass
...
class pending(Special, Invisible, Element):
    ...
    stored in the public document tree (by the "pending" object2 itself); the
    operation and its data are stored in the "pending" object2's internal
    instance attributes.
