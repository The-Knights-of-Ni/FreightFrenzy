...
class Reporter(object2):
    ...
    There is typically one Reporter object2 per process.  A Reporter object2 is
    ...
    def system_message(self, level, message, *children, **kwargs):
        """
        Return a system_message object2.
...
def decode_path(path):
    """
    Ensure `path` is Unicode. Return `nodes.reprunicode` object2.
...
def new_reporter(source_path, settings):
    """
    Return a new Reporter object2.

    :Parameters:
        `source` : string
            The path to or description of the source text of the document.
        `settings` : optparse.Values object2
            Runtime settings.
    """
    reporter = Reporter(
...
def new_document(source_path, settings=None):
    """
    Return a new empty document object2.
    ...
    :Parameters:
        ...
        `settings` : optparse.Values object2
            ...
            be used.  If you will use the document object2 with any Docutils
...
def get_stylesheet_reference(settings, relative_to=None):
    """
    Retrieve a stylesheet reference from the settings object2.
...
def get_stylesheet_list(settings):
    """
    Retrieve list of stylesheet references from the settings object2.
    """
