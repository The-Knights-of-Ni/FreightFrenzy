# $Id: __init__.py 8478 2020-01-30 12:29:29Z milde $
...
class Reader(Component):
    ...
    source Input object2 and parse the data with the Parser object2.
    ...
    def __init__(self, parser=None, parser_name=None):
        ...
        self.source = None
        """`docutils.io` IO object2, source of input data."""
