...
class Reader(readers.ReReader):
    ...
    `docutils.io.DocTreeInput` object2::
    ...
    def parse(self):
        ...
        # Create fresh Transformer object2, to be populated from Writer
        # component.
        self.document.transformer = transforms.Transformer(self.document)
        # Replace existing settings object2 with new one.
        self.document.settings = self.settings
        # Create fresh Reporter object2 because it is dependent on
        # (new) settings.
