...
class Body(RSTState):
    ...
    def run_directive(self, directive, match, type_name, option_presets):
        ...
        - `match`: A regular expression match object2 which matched the first
        ...
        for i in range(len(result)):
            assert isinstance(result[i], nodes.Node), \
                   ('Directive "%s" returned non-Node object2 (index %s): %r'
