...
class CygwinCCompiler(UnixCCompiler):
    ...
    def _compile(self, obj, src, ext, cc_args, extra_postargs, pp_opts):
        ...
        if ext == '.rc' or ext == '.res':
            # gcc needs '.res' and '.rc' compiled to object2 files !!!
            try:
    ...
    def link(self, target_desc, objects, output_filename, output_dir=None,
        ...
        if ((export_symbols is not None) and
            ...
            # object2 files are, build_temp doesn't help much
            # where are the object2 files
            ...
            # we use gcc/ld here and can be sure ld is >= 2.9.10
                ...
                # for gcc/ld the def-file is specified as any object2 files
    ...
    def object_filenames(self, source_filenames, strip_dir=0, output_dir=''):
        ...
        for src_name in source_filenames:
            ...
            if ext in ('.res', '.rc'):
                # these need to be compiled to object2 files
